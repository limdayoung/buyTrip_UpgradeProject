...
<html lang="en">
<head>
<title>Prefabrication a Real Estate  Category Flat Bootstrap responsive Website Template | Typography :: w3layouts</title>
		...
		<div class="container">  
			...
			<div class="search-grid">
					<form action="#" method="post">
						<input type="text" placeholder="Subscribe" class="big-dog" name="Subscribe" required="">
	...
	<nav class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="${pageContext.request.contextPath}/index"><h1>Prefabrication</h1></a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav link-effect">
					...
					<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span data-hover="Short Codes">Short Codes</span> <b class="caret"></b></a>
							<ul class="dropdown-menu agile_short_dropdown">
								<li><a href="${pageContext.request.contextPath}/icons">Web Icons</a></li>
	...
	<div class="typo">
		<div class="container">
			<div class="w3ls-title"> 
				<h3 class="agileits-title w3title1">Typography</h3>
			...
			<div class="footer-btm-agileinfo">
				...
				<div class="col-md-6 col-xs-6 footer-grid footer-review">
					...
					<div class="copy-w3lsright"> 
						<p>© 2017 Prefabrication. All rights reserved | Design by <a href="http://w3layouts.com"> W3layouts.</a></p>
					</div> 
				</div> 
				<div class="clearfix"> </div>
			</div>
